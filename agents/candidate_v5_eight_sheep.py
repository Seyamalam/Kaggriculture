"""Kaggriculture v5: eight-sheep policy with a lean seed pipeline.
...
SHEEP_TILES = ((4, 3), (3, 4), (3, 3), (2, 4), (5, 3), (6, 3), (6, 4), (7, 4))
SHEEP_COST = 500
FALLBACK_COUNT = 0
...
def _market_actions(obs: dict[str, Any]) -> list[list[Any]]:
    ...
    # cash arrives, then scale to eight after the first wool cycle.
    sheep_in_system = placed_sheep + carried_sheep + int(shed.get("SHEEP", 0))
    desired_sheep = 1 if day < 5 else (2 if day < 7 else 8)
    ...
    service_headroom = current_hands * 2 - placed_sheep * 3
    gap = (
